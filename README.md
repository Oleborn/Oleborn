...
| **Брокеры сообщений** |**Apache Kafka**: Построение высокопроизводительных, отказоустойчивых и масштабируемых систем обмена сообщениями. Опыт работы с Kafka Streams, Consumer Groups, Producers и Consumers для обработки событий в реальном времени. <br> **RabbitMQ**: Имею опыт развертывания и сопровождения брокеров. Понимаю фундаментальные различия в моделях потребления (competitive consumers vs consumer groups), что позволяет осознанно выбирать между RabbitMQ (низкая задержка, сложная маршрутизация) и Kafka (высокий throughput, лог-ориентированность). Настроил интеграцию через Spring AMQP / raw Java client с обработкой дедлоков и ретраев..|
| **Архитектура и интеграция** |**Microservices**: Разработка и декомпозиция монолитных приложений на микросервисы, управление межсервисным взаимодействием. <br>**REST API**: Проектирование и реализация стандартизированных API для взаимодействия сервисов. <br>**API Gateway**: Использование для маршрутизации, аутентификации, авторизации и балансировки нагрузки. <br>**gRPC**: Разработка высокопроизводительных RPC-сервисов с использованием Protocol Buffers для эффективной передачи данных. <br>**GraphQL**: Разработка эффективного API. <br>**FeignClient**: Декларативный HTTP-клиент для упрощения вызовов RESTful сервисов. |
| **Тестирование** |**JUnit, Mockito**: Модульное тестирование, имитация зависимостей. <br>**WireMock**: Имитация внешних HTTP-сервисов для интеграционного тестирования. <br>**Testcontainers**: Использование контейнеров Docker для интеграционного тестирования баз данных, брокеров сообщений и других зависимомостей. <br>**Zonky**: Поднятие баз данных в памяти в для интеграционного тестирования. | 
| **Безопасность** |**Spring Security**: Разработка безопасных систем, отвечающих последним трендам надежности. <br>**Keycloak**: Настройка и запуск внешнего провайдера, обеспечивающего полную безопасность приложения. | 
